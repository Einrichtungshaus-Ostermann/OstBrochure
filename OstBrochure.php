...
class OstBrochure extends Plugin
{
    ...
    public function build(ContainerBuilder $container)
    {
        ...
        $container->setParameter('ost_brochure.plugin_dir', $this->getPath() . '/');
        $container->setParameter('ost_brochure.view_dir', $this->getPath() . '/Resources/views/');
